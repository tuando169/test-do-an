                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-wrap h-[30vh] w-full justify-between">
                    <div
                      ...
                      style={{
                        backgroundImage: 'url("./Object/1.jpg")',
                      }}
                    ></div>
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage: 'url("./Object/2.jpg")',
                      }}
                    ></div>
                  </div>
                ...
                <div className="flex flex-col h-full">
                  <div className="flex flex-wrap h-full w-full">
                    <div
                      ...
                      style={{
                        backgroundImage: 'url("./Object/3.jpg")',
                      }}
                    ></div>
                    <div
                      className="h-[29%] md:w-[42%] w-[40%] bg-cover bg-center bg-no-repeat"
                      style={{
                        backgroundImage: 'url("./Object/4.jpg")',
                      }}
                    ></div>
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage: 'url("./Object/5.jpg")',
                      }}
                    ></div>
                    <div
                      className="h-[29%] w-[60%] mt-[6%] mb-[6%]  bg-cover bg-center bg-no-repeat"
                      style={{
                        backgroundImage: 'url("./Object/6.jpg")',
                      }}
                    ></div>
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage: 'url("./Object/7.jpg")',
                      }}
                    ></div>
                    <div
                      className="h-[15%] md:w-[25%] w-[22%]  bg-cover bg-center bg-no-repeat"
                      style={{
                        backgroundImage: 'url("./Object/8.jpg")',
                      }}
                    ></div>
                  </div>
                </div>
